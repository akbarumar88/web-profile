...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Okt 2021 pada 05.23
...
CREATE TABLE `hobi` (
  `id` int(11) NOT NULL COMMENT 'primary key A_I',
  `hobi` varchar(30) NOT NULL COMMENT 'Nama Hobi',
  `deskripsi` text NOT NULL COMMENT 'Deskrpsi Hobi',
  `img` varchar(30) NOT NULL,
  `idmhs` int(11) NOT NULL COMMENT 'ID Identitas Pemilik Hobi'
...
INSERT INTO `hobi` (`id`, `hobi`, `deskripsi`, `img`, `idmhs`) VALUES
(1, 'Di rumah saja', 'Hobi saya adalah berada di rumah saja, karena memang saya tipe orang yang tidak terlalu suka untuk keluar rumah kecuali jika ada keperluan. Namun, jika sudah bosan berada di rumah, sesekali syaa juga keluar bersama teman-teman.', 'home.png', 1),
(2, 'Menonton Film', 'Saya juga suka menonton Film. Jika sedang bosan atau ingin mengisi waktu luang dengan hiburan, saya biasa menonton film / animasi di Youtube, iQIYI, ataupun website yang lain.', 'camera.png', 1),
(3, 'Bersosial Media', 'Jika saya sedang di waktu luang atau di hari libur terutama, saya juga biasa menggunakan waktu tersebut untuk menghibur diri dengan bersosial media. Saya biasa bermain Instagram dan YouTube.', 'social-media.png', 1);
...
CREATE TABLE `identitas` (
  ...
  `npm` varchar(30) DEFAULT NULL COMMENT 'Nomor Pokok Mahasiswa',
  `nama` varchar(100) DEFAULT NULL COMMENT 'Nama Lengkap Mahasiswa',
  `notelp` varchar(20) DEFAULT NULL COMMENT 'No. Telp Mahasiswa',
  `email` varchar(50) DEFAULT NULL COMMENT 'Email Mahasiswa',
  `idprovinsi` int(11) DEFAULT NULL COMMENT 'id Provinsi (provinsi mahassiwa)',
...
INSERT INTO `identitas` (`id`, `npm`, `nama`, `notelp`, `email`, `idprovinsi`, `idkota`, `idkecamatan`) VALUES
(1, '19081010043', 'Akbar Umar Alfaroq', '083117208776', 'akbarumar88@gmail.com', 35, 3515, 3515100);
...
INSERT INTO `kecamatan` (`id`, `idkota`, `kecamatan`) VALUES
...
CREATE TABLE `keterampilan` (
  `id` int(11) NOT NULL,
  `kategori` enum('web','seluler','desktop') NOT NULL,
...
INSERT INTO `keterampilan` (`id`, `kategori`, `bahasa`, `id_html`) VALUES
(1, 'web', 'HTML', 'html5'),
(2, 'web', 'CSS', 'css3'),
(3, 'web', 'JavaScript', 'js'),
(4, 'web', 'PHP', 'php'),
(5, 'seluler', 'Android Native', 'android-native'),
(6, 'seluler', 'React Native', 'react-native'),
(7, 'desktop', 'Delphi 7', 'delphi'),
(8, 'desktop', 'Visual Basic .NET', 'vb');
...
INSERT INTO `kota` (`id`, `idprovinsi`, `kota`) VALUES
...
--
-- Struktur dari tabel `mhs_keterampilan`
--

CREATE TABLE `mhs_keterampilan` (
  `id` int(11) NOT NULL,
  `idmhs` int(11) NOT NULL,
  `idketerampilan` int(11) NOT NULL,
  `stat` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `mhs_keterampilan`
--

INSERT INTO `mhs_keterampilan` (`id`, `idmhs`, `idketerampilan`, `stat`) VALUES
(1, 1, 1, 50),
(2, 1, 2, 50),
(3, 1, 3, 60),
(4, 1, 4, 60),
...
--
-- Struktur dari tabel `mhs_sosmed`
--

CREATE TABLE `mhs_sosmed` (
  `id` int(11) NOT NULL,
  `idmhs` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `mhs_sosmed`
--

INSERT INTO `mhs_sosmed` (`id`, `idmhs`, `idsosmed`, `username`) VALUES
(1, 1, 1, 'arg50'),
(2, 1, 2, 'akbar-umar-alfaroq-9aa0a1145'),
(3, 1, 3, '__akbarumar__');
...
INSERT INTO `portofolio` (`id`, `idmhs`, `deskripsi`, `penerbit`, `img`) VALUES
(2, 1, '2nd Winner of Augmented Reality School Project (Southeast Asia Creative Camp)', 'SEAMEO SEAMOLEC', 'caros.jpg'),
(3, 1, '1st Winner LKS SMK IT Software Application Working Area', 'Kementrian Pendidikan dan Kebudayaan', 'lks_wilker.jpeg'),
(4, 1, '2nd Winner LKS SMK IT Software Application Province', 'Kementrian Pendidikan dan Kebudayaan', 'lks_provinsi.jpg'),
(5, 1, '2nd Winner FKBMIK Programming Competition 2019', 'UPN "Veteran" Jawa Timur', 'fkbmik.jpg');
...
--
-- Struktur dari tabel `riwayat_magang`
--
...
--
-- Dumping data untuk tabel `riwayat_magang`
--

INSERT INTO `riwayat_magang` (`id`, `idmhs`, `tglawal`, `tglakhir`, `peran`, `instansi`, `deskripsi`) VALUES
(1, 1, '2017-04-01', '2017-06-30', 'Junior Web Developer', 'CV KomputerKit.com', 'Bekerja untuk sebuah projek halaman web POS (Point Of Sale).');
...
INSERT INTO `riwayat_pendidikan` (`id`, `idmhs`, `tglawal`, `tglakhir`, `tingkat`, `instansi`, `deskripsi`) VALUES
(1, 1, '2007-07-01', '2013-06-30', 'Sekolah Dasar', 'SDN Sidotopo Wetan II Surabaya', 'Pendidikan Sekolah Dasar.'),
(2, 1, '2013-07-01', '2016-06-30', 'Sekolah Menengah Per', 'SMPN 1 Sukodono Sidoarjo', 'Pendidikan Sekolah Menengah Pertama.'),
(3, 1, '2016-07-01', '2016-06-30', 'Sekolah Menengah Kejuruan', 'SMKN 2 Buduran Sidoarjo', 'Pendidikan Sekolah Menengah Kejuruan, jurusan Rekayasa Perangkat Lunak.'),
(4, 1, '2019-07-01', '2019-07-01', 'S1 Teknik Informatika', 'UPN Veteran Jawa Timur Surabaya', 'Saat ini sedang menempuh pendidikan S1 Teknik Informatika di UPN Veteran Jawa Timur Surabaya.');
...
CREATE TABLE `sosmed` (
  ...
  `img` varchar(30) DEFAULT NULL COMMENT 'Gambar Sosial Media'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sosmed` (`id`, `nama`, `url`, `img`) VALUES
(1, 'Facebook', 'https://www.facebook.com', 'fb.png'),
(2, 'Linked In', 'https://www.linkedin.com/in', 'linkedin.png'),
(3, 'Instagram', 'https://www.instagram.com', 'ig.png');
...
ALTER TABLE `identitas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `identitas_fk` (`idprovinsi`),
  ADD KEY `identitas_fk_1` (`idkota`),
  ADD KEY `identitas_fk_2` (`idkecamatan`);
...
--
-- Indexes for table `mhs_keterampilan`
--
ALTER TABLE `mhs_keterampilan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mhs_keterampilan_fk` (`idmhs`),
  ADD KEY `mhs_keterampilan_fk_1` (`idketerampilan`);

--
-- Indexes for table `mhs_sosmed`
--
ALTER TABLE `mhs_sosmed`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mhs_sosmed_fk` (`idmhs`),
  ADD KEY `mhs_sosmed_fk_1` (`idsosmed`);
...
ALTER TABLE `riwayat_magang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `riwayat_magang_fk` (`idmhs`);
...
ALTER TABLE `riwayat_pendidikan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `riwayat_pendidikan_fk` (`idmhs`);
...
--
ALTER TABLE `hobi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'primary key A_I', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `identitas`
--
ALTER TABLE `identitas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'auto increment', AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `mhs_keterampilan`
--
ALTER TABLE `mhs_keterampilan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `mhs_sosmed`
--
ALTER TABLE `mhs_sosmed`
...
--
ALTER TABLE `identitas`
  ADD CONSTRAINT `identitas_fk` FOREIGN KEY (`idprovinsi`) REFERENCES `provinsi` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `identitas_fk_1` FOREIGN KEY (`idkota`) REFERENCES `kota` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `identitas_fk_2` FOREIGN KEY (`idkecamatan`) REFERENCES `kecamatan` (`id`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `mhs_keterampilan`
--
ALTER TABLE `mhs_keterampilan`
  ADD CONSTRAINT `mhs_keterampilan_fk` FOREIGN KEY (`idmhs`) REFERENCES `identitas` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `mhs_keterampilan_fk_1` FOREIGN KEY (`idketerampilan`) REFERENCES `keterampilan` (`id`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `mhs_sosmed`
--
ALTER TABLE `mhs_sosmed`
  ADD CONSTRAINT `mhs_sosmed_fk` FOREIGN KEY (`idmhs`) REFERENCES `identitas` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `mhs_sosmed_fk_1` FOREIGN KEY (`idsosmed`) REFERENCES `sosmed` (`id`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `portofolio`
--
ALTER TABLE `portofolio`
  ADD CONSTRAINT `portofolio_fk` FOREIGN KEY (`idmhs`) REFERENCES `identitas` (`id`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `riwayat_magang`
--
ALTER TABLE `riwayat_magang`
  ADD CONSTRAINT `riwayat_magang_fk` FOREIGN KEY (`idmhs`) REFERENCES `identitas` (`id`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `riwayat_pendidikan`
--
ALTER TABLE `riwayat_pendidikan`
  ADD CONSTRAINT `riwayat_pendidikan_fk` FOREIGN KEY (`idmhs`) REFERENCES `identitas` (`id`) ON UPDATE CASCADE;
